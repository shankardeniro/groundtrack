...
Vehicle photographs in `src/assets/vehicles/` (resized copies; all licenses verified on the linked source pages, August 2026):

| File | Vehicle | Source | Author / credit | License |
| --- | --- | --- | --- | --- |
| `falcon9.jpg` | Falcon 9 (Iridium-1 launch) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Iridium-1_Launch_(32312419215).jpg) | SpaceX | [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) |
| `electron.jpg` | Electron (TROPICS launch) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:TROPICS_Rocket_Launch_(KSC-20230507-PH-RLS01_0005-reupload).jpg) | NASA Kennedy Space Center / Rocket Lab | Public domain (NASA) |
| `newglenn.jpg` | New Glenn (BlueBird 7 launch) | [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:New_Glenn_-_BlueBird_7_Launch_(9628268).jpg) | U.S. Space Force, photo by Gwendolyn Kurzen | Public domain (U.S. federal government work) |
