...
- **Click a pin** to open the profile panel: description, key programs, milestone timeline, achievements, and clickable connections. Flagship launchers (Falcon 9, Electron, New Glenn, Vulcan, Ariane 6, Alpha, Vikram-1) show **real photographs** (freely licensed, credited — see [ATTRIBUTIONS.md](ATTRIBUTIONS.md)) plus a real-figures spec table; other vehicles get the spec table.
